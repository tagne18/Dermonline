...
<div class="container-fluid px-4 py-5">
    ...
    <div class="d-flex align-items-center mb-4">
        ...
        <div>
            <h1 class="mb-1 fw-light text-dark">Nouvel examen</h1>
            <p class="text-muted mb-0">Création d'un nouveau dossier d'examen médical</p>
        </div>
    </div>
        ...
        <div class="col-12 col-lg-8">
            <div class="card border-0 shadow-sm" style="border-radius: 16px; overflow: hidden;">
                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('medecin.examens.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" name="titre" id="titre" class="form-control rounded-3" 
                                           required placeholder="Titre de l'examen">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea name="description" id="description" class="form-control rounded-3" 
                                              style="height: 120px; resize: vertical;" placeholder="Description détaillée"></textarea>
                                    <label for="description" class="text-muted">
                                        <i class="fas fa-file-text me-2"></i>Description (optionnelle)
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-floating">
                                    <input type="date" name="date_examen" id="date_examen" class="form-control rounded-3" required>
                                ...
                                <div class="p-3 bg-light rounded-4">
                                    ...
                                    <div class="form-floating">
                                        ...
                                        <label for="fichier" class="text-muted">
                                            <i class="fas fa-upload me-2"></i>Sélectionner un fichier (optionnel)
                                        </label>
                                    </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="text-sm text-muted">
                        <div class="mb-3 p-3 bg-light rounded-3">
                            ...
                            <strong>Patient :</strong> Vérifiez que le patient est correct avant de créer l'examen
                        </div>
                        <div class="mb-3 p-3 bg-light rounded-3">
                            <i class="fas fa-heading text-info me-2"></i>
                            <strong>Titre :</strong> Soyez descriptif et utilisez une nomenclature claire
                        </div>
                        <div class="mb-3 p-3 bg-light rounded-3">
                            <i class="fas fa-calendar text-warning me-2"></i>
                            <strong>Date :</strong> Utilisez la date réelle de l'examen, pas celle de saisie
                        </div>
                        <div class="mb-3 p-3 bg-light rounded-3">
                            <i class="fas fa-file-upload text-primary me-2"></i>
                            <strong>Fichier :</strong> Privilégiez le format PDF pour les rapports
                        </div>
                    </div>
                </div>
            </div>
...
<style>
/* Styles personnalisés pour le formulaire moderne */
