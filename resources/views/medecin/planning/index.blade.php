...
<div class="container-fluid">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('medecin.planning.historique') }}" class="btn btn-outline-primary">
                <i class="fas fa-history me-2"></i>Historique
            </a>
            <a href="{{ route('medecin.planning.create') }}" class="btn-add-planning">
    ...
    <div class="card mb-4">
        <div class="card-body py-3">
            <form action="{{ route('medecin.planning.index') }}" method="GET" class="row g-3">
                <div class="col-md-3">
                    ...
                    <div class="card card-planning h-100">
                        <div class="planning-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="mb-0 text-white">{{ $planning->titre }}</h5>
                        ...
                        <div class="planning-body">
                            <div class="planning-date">
                                ...
                                <span>{{ $planning->date_consultation->format('d/m/Y') }}</span>
                            </div>
                            ...
                            <div class="planning-meta">
                                ...
                                <div class="meta-item">
                                    ...
                                    <span>{{ $planning->duree_formattee }}</span>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <span class="text-muted">{{ $planning->type_consultation_libelle }}</span>
                            </div>
                            
                            @if($planning->description)
                                <div class="mb-3">
                                    <p class="mb-1 text-muted small">Description :</p>
                                    <p class="mb-0">{{ Str::limit($planning->description, 100) }}</p>
                                </div>
                            @endif
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex gap-2">
                                    <a href="{{ route('medecin.planning.show', $planning) }}" class="btn-action btn-outline-primary">
                                        <i class="far fa-eye"></i>
                                    </a>
                                    @if($planning->statut == 'planifie')
                                        <a href="{{ route('medecin.planning.edit', $planning) }}" class="btn-action btn-outline-primary">
                                            <i class="far fa-edit"></i>
                                        </a>
                                        <form action="{{ route('medecin.planning.destroy', $planning) }}" method="POST" class="d-inline" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce planning ?')">
                                            @csrf
                                            @method('DELETE')
