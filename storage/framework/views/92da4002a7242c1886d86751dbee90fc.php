...
<div class="container mx-auto py-8">
    ...
    <div class="alert alert-info">
        ...
        Appointments: <?php echo e($appointments->count() ?? 0); ?>, 
        Consultations: <?php echo e($consultations->count() ?? 0); ?>, 
        Notifications: <?php echo e($notifications->count() ?? 0); ?>
            ...
            <div class="col-md-4 mb-4">
                <div class="card bg-primary text-white">
                    <div class="card-body text-center">
                        ...
                        <h2 class="display-4"><?php echo e($appointments->count() ?? 0); ?></h2>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card bg-success text-white">
                    <div class="card-body text-center">
                        ...
                        <h2 class="display-4"><?php echo e($consultations->count() ?? 0); ?></h2>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card bg-info text-white">
                    <div class="card-body text-center">
                        ...
                        <h2 class="display-4"><?php echo e($notifications->count() ?? 0); ?></h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-4">
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    <a href="<?php echo e(route('patient.appointments.index')); ?>" class="btn btn-primary btn-lg w-100">
                ...
                <div class="col-md-3 mb-3">
                    <a href="<?php echo e(route('patient.consultations.index')); ?>" class="btn btn-success btn-lg w-100">
                ...
                <div class="col-md-3 mb-3">
                    <a href="<?php echo e(route('patient.messages.index')); ?>" class="btn btn-info btn-lg w-100">
                ...
                <div class="col-md-3 mb-3">
                    <a href="<?php echo e(route('patient.abonnements.index')); ?>" class="btn btn-warning btn-lg w-100">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/tagne/Desktop/DSL/dermonline/resources/views/patient/dashboard.blade.php ENDPATH**/ ?>