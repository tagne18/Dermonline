...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        ...
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                <i class="bi bi-calendar-check me-2"></i><?php echo e(__('Prendre un rendez-vous')); ?>
            ...
            <div class="grid lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl border border-gray-100">
                        ...
                        <div class="p-6">
                <form method="POST" action="<?php echo e(route('patient.appointments.store')); ?>" class="space-y-6" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                        ...
                                        <div>
                                            ...
                                            <select name="doctor" id="doctor" required
                                                ...
                                                <?php $__currentLoopData = $medecins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medecin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($medecin->id); ?>" data-specialite="<?php echo e($medecin->specialite ?? 'Dermatologie'); ?>">
                                                        Dr. <?php echo e($medecin->name); ?> - <?php echo e($medecin->specialite ?? 'Dermatologie'); ?>
        ...
        <div id="successModal" class="fixed inset-0 z-50 flex items-center justify-center transition-all duration-300 bg-black/50 backdrop-blur-sm opacity-0 pointer-events-none" role="dialog" aria-modal="true" aria-labelledby="modal-title">
            <div class="relative w-full max-w-md px-6 py-8 mx-4 transition-all duration-300 transform -translate-y-10 bg-white rounded-xl shadow-2xl sm:mx-6 md:mx-0">
                ...
                <div class="text-center">
                    ...
                    <p class="mb-6 text-gray-600"><?php echo e(session('success')); ?></p>
...
<?php endif; ?>
<?php /**PATH /home/tagne/Desktop/DSL/dermonline/resources/views/patient/appointments/index.blade.php ENDPATH**/ ?>