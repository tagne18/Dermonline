        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-10 col-lg-8 col-xl-6">
                <div class="card medical-card p-4 position-relative">
                    ...
                    <!-- Formulaire -->
                    <form action="<?php echo e(route('doctor_application.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH /home/tagne/Desktop/DSL/dermonline/resources/views/doctor-application/create.blade.php ENDPATH**/ ?>