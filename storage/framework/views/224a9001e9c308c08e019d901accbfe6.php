...
document.getElementById('communityForm').addEventListener('submit', function(e) {
    ...
    // Send to the API
    fetch("<?php echo e(route('medecin.messages.store')); ?>", {
        method: 'POST',
        headers: {
...
function loadCommunityMessages() {
    fetch("<?php echo e(route('medecin.messages.index')); ?>")
        .then(response => response.json())
        .then(messages => {
            ...
            messages.forEach(msg => {
                ...
                const isCurrentUser = msg.user === "<?php echo e(auth()->user()->name); ?>";
...
<?php /**PATH /home/tagne/Desktop/DSL/dermonline/resources/views/components/chat/community.blade.php ENDPATH**/ ?>