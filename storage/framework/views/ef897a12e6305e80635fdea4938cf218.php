<?php $__env->startSection('title', 'Rendez-vous reçus'); ?>
...
<div class="appointments-container">
    <div class="content-wrapper">
        ...
        <!-- <div class="stats-info">
            <strong>Information :</strong> <?php echo e($appointments->count()); ?> rendez-vous trouvés pour le médecin ID: <?php echo e(auth()->id()); ?>
        ...
        <div class="table-responsive">
            <table class="table clean-table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rdv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="fade-in" data-status="<?php echo e($rdv->statut); ?>" data-patient-name="<?php echo e(strtolower($rdv->patient_name ?? $rdv->user->name ?? '')); ?>">
                            <td>
                                <div class="patient-name"><?php echo e($rdv->patient_name ?? $rdv->user->name ?? 'Patient inconnu'); ?></div>
                                <div class="patient-phone"><?php echo e($rdv->patient_phone ?? $rdv->user->phone ?? 'Téléphone non renseigné'); ?></div>
                            </td>
                            <td>
                                <?php if(!empty($rdv->photos)): ?>
                                    <img src="<?php echo e(asset('storage/' . $rdv->photos)); ?>" alt="Photo du patient" class="patient-photo">
                                <?php else: ?>
                                    <div class="no-photo">👤</div>
                                <?php endif; ?>
                            </td>
                            <td>
                                <div class="date-display"><?php echo e($rdv->date); ?></div>
                            </td>
                            <td>
                                <div class="motif-text"><?php echo e($rdv->motif); ?></div>
                            </td>
                            <td>
                                <div class="description-text" title="<?php echo e($rdv->description); ?>"><?php echo e($rdv->description); ?></div>
                            </td>
                            <td>
                                <div class="type-text"><?php echo e(ucfirst($rdv->type ?? 'Non défini')); ?></div>
                            </td>
                            <td>
                                <?php if($rdv->statut == 'en_attente'): ?>
                                    <span class="status-badge status-en-attente">En attente</span>
                                <?php elseif($rdv->statut == 'valide'): ?>
                            ...
                            <td>
                                <div class="actions-group">
                                    <?php if($rdv->statut == 'en_attente'): ?>
                                        <form method="POST" action="<?php echo e(route('medecin.appointments.validate', $rdv->id)); ?>" class="d-inline form-validate">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <form method="POST" action="<?php echo e(route('medecin.appointments.refuse', $rdv->id)); ?>" class="d-inline form-refuse">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <a href="<?php echo e(route('medecin.prescriptions.create', ['appointment' => $rdv->id])); ?>" class="btn btn-simple btn-primary-simple">Prescription</a>
                                        <button type="button" class="btn btn-simple btn-warning-simple" data-bs-toggle="modal" data-bs-target="#rescheduleModal" 
                                            data-appointment-id="<?php echo e($rdv->id); ?>" data-patient-name="<?php echo e($rdv->patient_name ?? $rdv->user->name ?? 'Patient inconnu'); ?>">
                                            Reprogrammer
                                        </button>
                                    <?php endif; ?>
                                    <button type="button" class="btn btn-simple btn-info-simple" data-bs-toggle="modal" data-bs-target="#messageModal" 
                                        data-patient-id="<?php echo e($rdv->user_id ?? $rdv->patient_id); ?>" data-patient-name="<?php echo e($rdv->patient_name ?? $rdv->user->name ?? 'Patient inconnu'); ?>">
                                        Message
                                    </button>
                                </div>
                            </td>
...
<div class="modal fade modal-simple" id="rescheduleModal" tabindex="-1" aria-labelledby="rescheduleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form method="POST" action="<?php echo e(route('medecin.appointments.reschedule')); ?>">
        <?php echo csrf_field(); ?>
...
<div class="modal fade modal-simple" id="messageModal" tabindex="-1" aria-labelledby="messageModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form method="POST" action="<?php echo e(route('medecin.messages.send')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.medecin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/tagne/Desktop/DSL/dermonline/resources/views/medecin/annonces/index.blade.php ENDPATH**/ ?>