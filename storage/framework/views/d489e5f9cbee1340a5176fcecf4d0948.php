            ...
            <?php echo csrf_field(); ?>
                ...
                <?php if(Route::has('password.request')): ?>
                        <div class="text-center mb-3">
                            <a href="<?php echo e(route('password.request')); ?>" class="text-decoration-none" style="color: var(--primary-color);">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-register text-dark w-100">
...
<?php /**PATH /home/tagne/Desktop/DSL/dermonline/resources/views/auth/login.blade.php ENDPATH**/ ?>