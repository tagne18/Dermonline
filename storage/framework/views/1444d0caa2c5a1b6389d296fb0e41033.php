<?php $__env->startSection('title', 'Créer un planning'); ?>
...
<div class="container-fluid">
    ...
    <div class="form-container">
        <form action="<?php echo e(route('medecin.planning.store')); ?>" method="POST" id="planningForm">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                               id="titre" name="titre" value="<?php echo e(old('titre')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" 
                                   class="form-control <?php $__errorArgs = ['date_consultation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('date_consultation')); ?>" 
                                   min="<?php echo e(date('Y-m-d')); ?>"
                                   required>
                            <?php $__errorArgs = ['date_consultation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="time-input-group">
                            <div class="time-input">
                                ...
                                <input type="time" class="form-control <?php $__errorArgs = ['heure_debut'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       id="heure_debut" name="heure_debut" value="<?php echo e(old('heure_debut', '09:00')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="time-input">
                                ...
                                <input type="time" class="form-control <?php $__errorArgs = ['heure_fin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       id="heure_fin" name="heure_fin" value="<?php echo e(old('heure_fin', '17:00')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select <?php $__errorArgs = ['duree_consultation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <option value="15" <?php echo e(old('duree_consultation', '30') == 15 ? 'selected' : ''); ?>>15 minutes</option>
                            <option value="30" <?php echo e(old('duree_consultation', '30') == 30 ? 'selected' : ''); ?>>30 minutes</option>
                            <option value="45" <?php echo e(old('duree_consultation', '30') == 45 ? 'selected' : ''); ?>>45 minutes</option>
                            <option value="60" <?php echo e(old('duree_consultation', '30') == 60 ? 'selected' : ''); ?>>1 heure</option>
                            <option value="90" <?php echo e(old('duree_consultation', '30') == 90 ? 'selected' : ''); ?>>1h30</option>
                            <option value="120" <?php echo e(old('duree_consultation', '30') == 120 ? 'selected' : ''); ?>>2 heures</option>
                        </select>
                        <?php $__errorArgs = ['duree_consultation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="type-consultation">
                            <label class="type-option <?php echo e(old('type_consultation', 'presentiel') == 'presentiel' ? 'active' : ''); ?>">
                                <input type="radio" name="type_consultation" value="presentiel" 
                                       class="form-check-input" <?php echo e(old('type_consultation', 'presentiel') == 'presentiel' ? 'checked' : ''); ?> required>
                                <i class="fas fa-building"></i>
                                <div>Présentiel</div>
                            </label>
                            
                            <label class="type-option <?php echo e(old('type_consultation') == 'en_ligne' ? 'active' : ''); ?>">
                                <input type="radio" name="type_consultation" value="en_ligne" 
                                       class="form-check-input" <?php echo e(old('type_consultation') == 'en_ligne' ? 'checked' : ''); ?>>
                                <i class="fas fa-video"></i>
                                <div>En ligne</div>
                            </label>
                            
                            <label class="type-option <?php echo e(old('type_consultation') == 'hybride' ? 'active' : ''); ?>">
                                <input type="radio" name="type_consultation" value="hybride" 
                                       class="form-check-input" <?php echo e(old('type_consultation') == 'hybride' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="prix" name="prix" value="<?php echo e(old('prix', '5000')); ?>" min="0" step="100" required>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        <?php if(old('date_consultation')): ?>
            try {
                const [year, month, day] = '<?php echo e(old('date_consultation')); ?>'.split('-');
...
<?php echo $__env->make('layouts.medecin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/tagne/Desktop/DSL/dermonline/resources/views/medecin/planning/create.blade.php ENDPATH**/ ?>