<?php $__env->startSection('title', 'Profil du Médecin'); ?>
            ...
            <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                    ...
                    <div class="bg-gradient-primary" style="height: 120px; position: relative;">
                        <div class="position-absolute" style="bottom: -60px; left: 50%; transform: translateX(-50%);">
                            <div class="position-relative">
                                <img src="<?php echo e(Auth::user()->profile_photo_url ?? asset('images/default.jpeg')); ?>" 
                                     alt="Photo de profil" 
                ...
                <div class="card-body pt-5 pb-4">
                    ...
                    <div class="text-center mb-4 mt-3">
                        <h2 class="fw-bold text-primary mb-2"><?php echo e(Auth::user()->name); ?></h2>
                        <div class="mb-3">
                            <span class="badge bg-primary-subtle text-primary px-4 py-2 rounded-pill fs-6">
                                <i class="fas fa-stethoscope me-2"></i><?php echo e(Auth::user()->specialite); ?>
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="fw-medium"><?php echo e(Auth::user()->birth_date ? \Carbon\Carbon::parse(Auth::user()->birth_date)->age . ' ans' : 'Non renseigné'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="fw-medium"><?php echo e(Auth::user()->gender ? ucfirst(Auth::user()->gender) : 'Non renseigné'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="fw-medium"><?php echo e(Auth::user()->phone ?: 'Non renseigné'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="fw-medium"><?php echo e(Auth::user()->ville ?: 'Non renseigné'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="fw-medium"><?php echo e(Auth::user()->langue ?: 'Non renseigné'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="fw-medium"><?php echo e(Auth::user()->lieu_travail ?: 'Non renseigné'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="fw-medium"><?php echo e(Auth::user()->experience_professionnelle ?: 'Non renseigné'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="fw-medium font-monospace"><?php echo e(Auth::user()->numero_licence ?: 'Non renseigné'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <span class="fw-medium font-monospace"><?php echo e(Auth::user()->matricule_professionnel ?: 'Non renseigné'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <span class="fw-medium"><?php echo e(Auth::user()->domaine_expertise ?: 'Non renseigné'); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="card border-0 bg-secondary-subtle rounded-3">
                                <div class="card-body p-4">
                                    ...
                                    <p class="mb-0 text-muted lh-lg"><?php echo e(Auth::user()->a_propos); ?></p>
                                </div>
                            </div>
                        </div>
                        <?php endif; ?>
                    ...
                    <div class="text-center mt-5">
                        <a href="<?php echo e(route('medecin.profile.edit')); ?>" 
...
<?php echo $__env->make('layouts.medecin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/tagne/Desktop/DSL/dermonline/resources/views/medecin/profile/show.blade.php ENDPATH**/ ?>